...
<div>
  <div>
    <div>
      <table class="tabs5" id="roleView">
        ...
        <#if ctList?exists && ctList?size != 0>
			...
			<input type="hidden" name="scoreSaveView"  value="scoreDeptSave"> 
	        <#assign num = 0>
         	<#list ctList as ct>
         		<#assign x = 0>
         		<#list ctsList as cts>
         		...
         		<#list ctsList as cts>
         			<#if ct.id == cts.checkTarget.parent.id>
         				...
         				<textarea name="csList[${num}].gradeExplain" cols="17" rows="1" class="{maxlength:255, messages:{maxlength:' 最大长度为255字节'}}">${csList[num].gradeExplain?default("")}</textarea>
         				<td>
         				</tr>
         				<#assign y = y+1>
         				<#assign num = num+1>        				
    ...
    <div class="sb_margin">
        <div class="btn_position"><input name="submit" type="submit" value="保存"  class=" btn2_s"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" class="link_btn" onclick="cl();">关闭窗口</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <#if message?exists>
