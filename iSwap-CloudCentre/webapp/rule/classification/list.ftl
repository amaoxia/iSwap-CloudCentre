...
<div class="frameset_w" style="height:100%">
  <div class="main">
    ...
    <div class="main_c">
    <form  action="${path}/rule/classification/classification!list.action" method="post" id="pageForm" name="pageForm">
