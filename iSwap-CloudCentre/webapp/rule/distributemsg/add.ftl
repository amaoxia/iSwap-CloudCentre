...
<body>
<form name="save" id="saveForm" method="post" action="${path}/rule/distributemsg/distributemsg!add.action"/>
    ...
    <div class="main_c2" >
      ...
      <div class="right_main">
        <div class="loayt_01 rlist100">
          <div class="loayt_top"> <span class="loayt_tilte"><b>新建本地目录监听信息 </b></span><span class="loayt_right"><img src="${path}/images/kuang_right.png" width="10" height="31" /></span> </div>
                      ...
                      <td  height="100%" valign="top" ><div>
                          <ul class="item1_c">
							...
							<!--li class="item2_bg">
                              <p><b>*</b>所属应用：</p>
                              <span>
                              <select name="appMsg.id" id="appMsg"><option value="">---请选择---</option><#list appMsgList as app><option value="${app.id}">${app.appName?default('')}</option></#list></select>
                              </span>
                            ...
                            <li class="item2_bg">
                              <p><b>*</b>监听目录：</p>
                              <span>
                              <input type="text" size="30" value="C:/test" name="filePath" id="filePath"/>
                              </span>
...
<script type="text/javascript">
	...
	async : true,//异步加载 
	asyncUrl: "${path}/exchange/item/item!getItemtree.action",//数据文件 
	showLine:true,
	isSimpleData:true,
	treeNodeKey:"id",
