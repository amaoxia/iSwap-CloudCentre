...
<body>
<form name="pageForm" method="post"  action="${path}/cloudstorage/dataAuth/dataAuth!listMeta.action?type=${type?default('')}">
       				 ...
       				 <tr>
		          			<td align="right">
						       ...
						       <#list listDatas as entity>
						          ...
						          <td>
		      							<a href="javascript:void(0)" onclick="opdg('${path}/cloudstorage/dataAuth/dataAuth!addView.action?id=${entity.id}&itemId=${entity.metaData.id}','数据使用申请','950','560')"  id="hz0" class="tabs1_cz">
