...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="width:100%;height:100%;">
		 <form name="saveForm" action="${path}/cloudstorage/metaDataMapper/metaDataMapper!add.action" method="post" id="saveForm">	
			<@s.token name="token"/>
			<input type="hidden" name="mapper.tarMetaData.id" value="${metaDataId}"/>
...
<script type="text/javascript">
	var srcSelectStr = '';
	var tarSelectStr = '';
	$.post('${path}/cloudstorage/tableinfo/tableinfo!getTableInfo4Ajax.action?currTime='+new Date(),{metaDataId:'${metaDataId}'},function(result, status){
