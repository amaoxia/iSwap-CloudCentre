...
<body>
<form nam="saveForm" id="saveForm" method="post" action="${path}/cloudstorage/apply/apply!addAuth.action?id=${id}">
                       ...
                       <#list metaAuthList as entity>
                       		<#if entity_index==0>
				                <tr>
				                  ...
				                  <a href="#">
				                  <input type="checkbox"   value="${entity.id}" name="ids" <#if entity.filedAuthState=="1">checked</#if>/>&nbsp;&nbsp;${entity.tableInfo.name?default('')}
				                  </a>
				                  </td>
