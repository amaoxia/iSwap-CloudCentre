...
<div class="frameset_w" style="height:500px;background-color:#FFFFFF;">
  <div class="main"><div>
   <form name="save" action="${path}/cloudstorage/datasource/datasource!update.action" method="post" id="saveForm">
			  ...
			  <td  height="100%" valign="top" ><div class="">
				  <ul class="item1_c">
					<li>
					  ...
					  <p> <b>*</b>数据源编码：</p>
					  <span>
					  <input type="text" size="30" name="sourceCode" id="sourceCode" value="${sourceCode?default('')}"/>
					  </span> 
