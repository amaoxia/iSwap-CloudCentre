		...
		<div class="pop_01" id="wpageslide" style="width:622px;height:500px;overflow-x:hidden;overflow-y:scroll;">
			<div id="wpages" class="wpages">
				<div class="pop_mian wpage">
					<form method="post" action="${path}/cloudstorage/metadata/metadata!add.action" id="saveForm">
						<@s.token name="token"/>
												...
												<div class="item1">
													<ul class="item1_c">
														<li>
															...
															<span> 
																<input type="text" size="30" name="targetName" id="targetName" /> </span> <span>
																<div id="targetNameTip"></div> 
															</span>
														</li>
														<!--
									                    <li class="item_bg">
														...
														<li class="item_bg">
															...
															<span> 
																<input type="text" id="deptName" size="30" value="${deptName}" disabled="disabled" /> 
																<input type="hidden" id="deptId" name="sysDept.id" value="${deptId}" /> 
																<input type="hidden" name="type" value="${type?default('')}" /> 
																<input type="hidden" id="id" value="0" /> 
															</span> 
															<span>
																<div id="deptNameTip"></div> 
															</span>
														</li>
														<li>
															<p>
														...
														<li class="item_bg">
															...
															<span>
																<div id="metaDataBasicTypeIdTip"></div> 
															</span>
														</li> 
														</#if>
														<li <#if type=='1'>class="item_bg"</#if>>
															...
															<span> 
																<input type="text" name="tableName" id="tableName" size="30" />
															</span>
															<span>
																<div id="tableNameTip"></div> 
															</span>
														</li>
														<li <#if type!='1'>class="item_bg"</#if>>
															<p>
															...
															<span> 
																<input type="text" name="overPeople" id="overPeople" size="30" value="${overPeople?default('')}" /> 
															</span> 
															<span>
																<div id="overPeopleTip"></div> 
															</span>
														</li>
														<li class="item_bg">
															<p>
															...
															<span> 
																<input type="text" name="overPeopleEmail" id="overPeopleEmail" size="30" value="${overPeopleEmail?default('')}" /> 
															</span> 
															<span>
																<div id="overPeopleEmailTip"></div> 
															</span>
														</li>
													</ul>
												</div>
