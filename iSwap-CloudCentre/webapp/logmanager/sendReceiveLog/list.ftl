			...
			<div class="frameset_w" style="height:100%">
     		...
     		<div class="c_m_title"><img src="${path}/images/title/role.png"  align="absmiddle" />发送/接收日志</div>
    		</div>
    		<div class="main_c">
          ...
          <th>数据量</th>
		  <th>结果</th>
		  <th>时间<a href="javascript:void(0);" onclick="setOrder(this)" name="e.createDate">&nbsp;&nbsp;&nbsp;<img src="${path}/images/tabs_arr.png" align="absmiddle" /></a></th>
		  <th width="20%">操作</th>
           </tr>
