...
<form action="${path}/sysmanager/email/email!add.action" method="post" name="saveForm" id="saveForm" >
<@s.token name="token"/>
              ...
              <div class="item1">
                  <ul class="item1_c">
                   <li class="item_bg">
                      ...
                      <span>
                      <input type="hidden" id="id"  value="0"/>
                      <input type="text" size="30" id="emailAccount" name="emailAccount" />
                      </span> 
                      ...
                      <p><b>*</b>邮箱密码：</p>
                      <span>
                      <input type="password" size="30" id="emailPassWord" name="emailPassWord" />
                      </span> 
                      ...
                      <p><b>*</b>重复密码：</p>
                      <span>
                      <input type="password" size="30" id="tpass" name="tpass"/>
                      </span> 
                    ...
                    <li>
                      <p><b>*</b>邮箱服务器地址：</p>
                      <span>
                      <input type="text" size="30" id="emailAddress"  name="emailAddress" maxlength="20"/>
                      </span>
                    ...
                    <li class="item_bg">
					  <p><b>*</b>邮箱SMTP地址：</p>
                      <span>
                      <input type="text" size="30" id="emailServerAddress" name="emailServerAddress" />
                      </span>
