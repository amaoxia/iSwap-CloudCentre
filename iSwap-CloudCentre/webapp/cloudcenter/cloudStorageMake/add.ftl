...
<body>
<form action="cloudStorageMake!add.action" method="post" name="saveForm" id="saveForm">
<@s.token name="token"/>
			  ...
			  <td  height="100%" valign="top" ><div class="">
				  <ul class="item2_c">
					<li>
					  <p>空间名称：</p>
					  <span>
					  <input type="text" size="44" name="storageName" id="storageName"/>
					  </span> 
					...
					<li class="">
					  <p>描述</p>
					  <span>
					  <textarea  name="description" cols="42" rows="5"></textarea>
					  </span>
					</li>
				  </ul>
				</div></td>
