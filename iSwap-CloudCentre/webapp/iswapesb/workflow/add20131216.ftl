			...
			<tr>
			  <td  height="100%" valign="top" ><div class="">
				  <ul class="item2_c">
					...
					<li class="item2_bg">
					  <p>流程代码：</p>
					  <span><input type="text" name="workFlowCode" id="workFlowCode" size="30"/></span>
					  <span><div id='workFlowCodeTip'></div></span>
					</li>	
					<li>
					  <p>应用：</p>
					  <span>
					     <select name="appMsg.id" id="appMsgId" style="width:200px"> 
					      <option value="">--请选择--</option>
					     <#list appMsgList as entity>
					        <option value="${entity.id?default('')}">${entity.appName?default('')}</option> 
					     </#list>
					     </select> 
					  </span>
