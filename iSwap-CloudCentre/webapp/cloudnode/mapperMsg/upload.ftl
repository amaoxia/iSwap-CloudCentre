...
<div id="wpages" class="wpages">
  <div class="pop_mian wpage">
   <form name="save" id="saveForm" action="${request.getContextPath()}/cloudnode/mapperMsg/mapper!upload.action" enctype="multipart/form-data"  method="post">
			  ...
			  <td  height="100%" valign="top" ><div class="">
				<ul class="item1_c">
					<li>
					  <p><b>*</b>Mapper中文名称：</p>
					  <span>
					  <input type="text" size="30" name="mapName" id="mapName"/>
					  </span> 
					...
					<li class="item2_bg">
					  <p><b>*</b>Mapper英文名称：</p>
					  <span>
					  <input type="text" size="30" id="mapCode" name="mapCode"/>
					  </span> 
					...
					<li class="">
					  <p><b>*</b>Mapper文件</p>
					  <span>
						<input type="file" disable="true" name="fileupload" id="fileupload" style="width:280px;" />
					  </span>
					  <span> <div id="fileuploadTip"></div></span>
					</li>
				  </ul>
...
<script type="text/javascript"> 
$(document).ready(function(){
	$("div#wpageslide").wPageSilde({width: 622,height:450});
});
