...
<body>
<form name="save" id="saveForm" method="post" action="${path}/cloudnode/cloudnodeListen/cloudnodeListen!update.action"/>
    ...
    <div class="main_c2" >
      ...
      <div class="right_main">
        <div class="loayt_01 rlist100">
          <div class="loayt_top"> <span class="loayt_tilte"><b>编辑存储监听信息 </b></span><span class="loayt_right"><img src="${path}/images/kuang_right.png" width="10" height="31" /></span> </div>
                      ...
                      <td  height="100%" valign="top" ><div>
                          <ul class="item1_c">
                            ...
                            <li class="item2_bg">
                              <p><b>*</b>实例名称：</p>
                              <span>
                              <input type="text" size="30"  value="${dbName?default('')}" name="dbName" id="dbName"/>
                              </span>
							...
							<li class="">
                              <p><b>*</b>表名称：</p>
                              <span>
                              <input type="text" size="30" name="collectionName" value="${collectionName?default('')}" id="collectionName"/>
                              </span>
							...
							<li class="item2_bg">
                              <p><b>*</b>字段名称：</p>
                              <span>
                              <input type="text" size="30" name="filedName" value="${filedName?default('')}" id="filedName"/>
                              </span>
							...
							<li> 
                              <p><b>*</b>字段状态：</p>
                              <span>
                              	<input type="text" size="30" name="filedStatus" id="filedStatus" value="${filedStatus?default('')}"/>
                              </span>
