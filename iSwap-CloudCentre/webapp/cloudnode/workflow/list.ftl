  ...
  <head>
    ...
    <body>
          <div class="common_menu">
          	<span id="showDetailSpan" style="display:none;">数据提供方：<span id="sendDeptSpan"></span>&nbsp;&nbsp;&nbsp;数据接收方：<span id="receiceDeptsSpan"></span></span>
            <div class="c_m_btn">
              <span class="cm_btn_m">
                <a href="javascript:void(0)" onclick="opdg('${path}/cloudnode/workflow/workflow!addView.action?changeItemId=${changeItemId?default('')}','流程注册','450','250');">
                  <b>
              ...
              <table class="tabs1" style="margin-top:0px;">
                ...
                <#list listDatas as entity>
                  <tr <#if entity_index%2==0>class="trbg"</#if>  onclick="selectedTD(this);">
                    ...
                    <td width="8%">
                    <#if (entity.changeItem?exists)>
                      <#if entity.changeItem.itemType==2>
                        	接收
                      </#if>
                      <#if entity.changeItem.itemType==1>
                     	   发送
                      </#if>
                     </#if>
                    </td>
                    ...
                    <td width="25%">
                    <#if entity.status=='0'>
                      <a href="javascript:void(0)" class="tabs1_cz" onclick="opdg('${path}/cloudnode/workflow/workflow!updateView.action?deptId=${deptId?default('')}&id='+${entity.id},'编辑流程信息','450','250');">
                     ...
                     <#if entity.status=='1'>
                      ...
                      &nbsp;
                      <#if entity.status=='0'>
                       <a id="hz8" href="#"  onclick="updateProcess('${entity.id}','${entity.changeItem.sysDept.id}','${entity.workFlowCode?default('')}','0');" class="tabs1_cz">
