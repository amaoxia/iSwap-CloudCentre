...
<body>
<form name="save" id="saveForm" method="post" action="${path}/cloudnode/messagelisten/messagelisten!update.action?deptId=${deptId?default('')}"/>
                      ...
                      <td  height="100%" valign="top" ><div>
                          <ul class="item1_c">
                            ...
                            <li class="item2_bg">
                              <p><b>*</b>消息管理名称：</p>
                              <span>
                              <select id="jmsServerInfo" name="jmsServerInfo.id"><option value="">---请选择---</option><#list jmsServerList as jmsServer ><option value="${jmsServer.id}" <#if jmsServer.id==jmsServerInfo.id>selected</#if> >${jmsServer.jmsServerName}</option></#list></select>
                              </span>
							...
							<li>
                              <p><b>*</b>队名名称：</p>
                              <span>
                              <input type="text" size="30" name="queueName" id="queueName" value="${queueName?default('')}"/>
                              </span> 
