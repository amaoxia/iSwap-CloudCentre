...
<body>
<form name="update" id="update" method="post" action="${path}/cloudnode/ftplisten/ftplisten!update.action?deptId=${deptId?default('')}" id="saveForm"/>
    ...
    <div class="main_c2" >
      ...
      <div class="right_main">
        <div class="loayt_01 rlist100">
          <div class="loayt_top"> <span class="loayt_tilte"><b>编辑目录监听信息 </b></span><span class="loayt_right"><img src="${path}/images/kuang_right.png" width="10" height="31" /></span> </div>
                      ...
                      <td  height="100%" valign="top" ><div>
                          <ul class="item1_c">
                            ...
                            <li class="item2_bg">
                              <p><b>*</b>FTPServer：</p>
                              <span>
                              <select name="ftpServerInfo.id" id="ftpServerInfo"><option value="">---请选择---</option><#list ftpServerList as ftpServer><option value="${ftpServer.id}" <#if ftpServerInfo.id==ftpServer.id>selected</#if> >${ftpServer.ftpServerName}</option></#list></select>
                              </span>
							...
							<li class="">
                              <p><b>*</b>文件路径：</p>
                              <span>
                              <input type="text" size="30" name="filePath" id="filePath" value="${filePath?default('')}"/>
                              </span>
							...
							<li class="item2_bg">
                              <p><b>*</b>文件名称：</p>
                              <span>
                              <input type="text" size="30" name="fileName" id="fileName" value="${fileName?default('')}"/>
                              </span>
							...
							<li class="">
                              <p>描述：</p>
                              <span>
                              <textarea  name="notes" cols="42" rows="3">${notes?default('')}</textarea>
                              </span>
...
<script type="text/javascript">
	...
	async : true,//异步加载 
	<#--asyncUrl: "${path}/cloudnode/workflow/workflow!getWorkFlowByDeptId.action?workFlowId=${workFlow.id}&deptId=${deptId?default('')}",//数据文件  -->
	showLine:true,
	isSimpleData:true,
	treeNodeKey:"id",
