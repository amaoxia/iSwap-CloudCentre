...
<html>
	...
	<body>
		        <form  name="saveForm" id="saveForm"  action="jmsInfoAction!add.action" method="post">
		         <@s.token/>
						...
						<tr>
		                  ...
		                  <ul class="item2_c">
		                     <li>
		                      ...
		                      <span>
		                      	<input name="jmsServerName" id="jmsServerName" type="text" size="30" />
		                      </span>
		                    ...
		                    <li  class="item2_bg">
		                       <p><b style="color:red">*</b>上下文工厂：</p>
			                    <span>
			                      	<input name="jmsFactory" id="jmsFactory" type="text" size="30" />
			                    </span>
		                    ...
		                    <li>
		                       ...
		                       <span>
		                      <input name="conntFactory" id="conntFactory" type="text" size="30" />
		                      </span>
