$(document).ready(function() {
	...
	$("#ftpServerName").formValidator({
		...
		url : "ftpInfoAction!checkName.action",
		dataType : "html",
	...
	$("#filePath").formValidator({
		...
		min : 1,
		max : 200,
		onError : "服务路径输入有误，请重新输入"
	});
	$("#outTimes").formValidator({
		onShow : "请输入超时时长",
		onFocus : "此项为选择 必填!",
		onCorrect : "通过"
	}).regexValidator({
