...
<body class="pm01_c">
	<form method="post" action="${path}/appitemmgr/appItem/appItem!update.action" id="saveForm">
              ...
              <div class="item1">
                  <ul class="item1_c">
                    <li>
                      <p>指标名称:</p>
                      <span>
                      <input type="text" size="30" name="appItemName" id="appItemName" value="${appItemName?default('')}"/>
                      </span>
                    ...
                    <li class="item_bg">
                      <p>指标编码:</p>
                      <span>
                      <input type="text" value="${appItemCode?default('')}" disabled="disabled" size="30"/></span>
                      </li>
                     -->
                     <li>
						  <p>描述</p>
