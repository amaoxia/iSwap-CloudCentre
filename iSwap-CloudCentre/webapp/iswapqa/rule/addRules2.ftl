...
function saveWin() {
	//实现逻辑
	var ruleFileStr = document.getElementById("ruleFileStr").value;
	
	if(ruleFileStr!=null&&ruleFileStr!=""){
		addRules();
	}else{
		if (saveChecked()) {
			addRules();
                  ...
                  <div class="clear"></div>
                   <div class="tag_mainc" id="rule2" style="display:none;" >
                     <iframe id="reportFrame2"  scrolling="no" frameborder="no" border="0" width="100%" height="350px;" 
                      src="${path}/iswapqa/rule/ruleAction!addRuleShow.action"></iframe>
                  </div>
    ...
    <input name="input" type="button" value="添加条件" class=" btn2_s" style="padding:0;margin-top:20px;"/> <a href="#" id="caseAddClose" class="link_btn">取消</a>
              ...
              <div class="TabbedPanelsContent tag_h">
                <div class="tag_bg3">
                  ...
                  <div class="tag_R"><a href="#"></a></div>
                  <div class="clear"></div>
                </div>
                <div class="tag_nr3" style="height:340px;">
                  <div class="tag_nr_c" > </div>
                  <textarea name="ruleFileStr" id="ruleFileStr" cols="" rows="23" style="width:640px; margin-left:4px;"></textarea>
                </div>
              </div>
            </div>
          </div>
...
//设置条件
 ...
 //设置行为	
 	...
 	alert(document.getElementById("thenMapVal").value);
