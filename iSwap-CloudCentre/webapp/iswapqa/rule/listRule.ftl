...
<div class="float_div2 float_div2_pos">
  <div class="float_main2 float_tboder">
    ...
    <input name="input" type="button" value="添加条件" class=" btn2_s" style="padding:0;margin-top:20px;"/> <a href="#" id="caseAddClose" class="link_btn">取消</a>
                      ...
                      <input type="hidden" name="whenMapKey" id="whenMapKey" value="${ruleObj?default("")}"/>
              ...
              <#list attributeMap?keys as attrKey>   
               <#assign i = i+1>  
                          <tr>
                            <th><span value="attrKey">${attrKey?split("|")[1]}
                            	<input type="hidden" name="objAttr"  value="${attrKey?split("|")[0]}|${attributeMap[attrKey]}|${attrKey?split("|")[1]}"/>
                            </th>
                            <td>
                             <#if attributeMap[attrKey]=="boolean">
                            <input type="radio" name="${attrKey?split("|")[0]}Val" id="${attrKey?split("|")[0]}Val" value="true" checked="checked" />
                     		  是
                              <input type="radio" name="${attrKey?split("|")[0]}Val" id="${attrKey?split("|")[0]}Val" value="false" />
                              否<a href="#"><img src="${path}/images/tag_del2.gif" align="absmiddle"  class="tab1_cont_del" onclick="delCondition(this)" /></a>
                               </#if>
                               
                                <#if attributeMap[attrKey]=="string">
                         <input type="text"  id="${attrKey?split("|")[0]}Val" size="30" name="strName" />
                              <a href="#"><img src="${path}/images/tag_del2.gif" align="absmiddle"  class="tab1_cont_del" onclick="delCondition(this)" /></a>
                               </#if>
                               
                                <#if attributeMap[attrKey]=="number">
                        	<select name="select" id="${attrKey?split("|")[0]}Val1" name="numDateName">
                        	<option value="">请选择</option>
                              ...
                              <input type="text" size="13" id="${attrKey?split("|")[0]}Val2" name="numDateName"/>
                              <select name="select2" id="${attrKey?split("|")[0]}Val3" onchange="noSelect('${attrKey?split("|")[0]}')">
                              <option value="">请选择</option>
                                <option value="&&">与(and)</option>
                                 <option value="||">或(or)</option>
                                <option value="" >不选</option>
                              </select>
                              <select name="select3" id="${attrKey?split("|")[0]}Val4">
                              	<option value="">请选择</option>
                               	<option value="=">=</option>
                               	 <option value=">">&gt;</option>
                               	  <option value="<">&lt;</option>
                              ...
                              <input type="text" size="13" id="${attrKey?split("|")[0]}Val5"/>
      						 ...
      						 <tr>
       						 <td>对象
						          ...
						          <select name="ruleObj" id="ruleObj" style="width:150px;">
						           <#if objList?exists>
          				 <#list objList as obj>   
          				<option value="${obj.enName}|${obj.cnName}|${obj.path}">${obj.cnName}</option>
           				</#list>
         				 </#if>
          						</select></td>
						 </tr>
        ...
        <div class="btn_certer">
            ...
            &nbsp;&nbsp;
            <input name="input" type="button" value="保存" onclick="saveWin()"  class=" btn2_s"/>
            &nbsp;              &nbsp;</div>
 ...
 <div class="float_div3 float_div3_pos" >
  <div class="float_main3 float_tboder">
    ...
    <div class="tag_nr_c" > <span>
      <input type="checkbox" name="options" id="checkbox" value="salience|优先级" />
      优先级</span><span>
...
function addRulesObj(){
	...
	ruleObjTable.insertRow(); //插入行
	 ...
	 ruleObjTable.rows[ruleObjTable.rows.length-1].cells[1].innerHTML= " <input type=\"hidden\" name=\"thenObj\" id=\"thenObj\"  value=\""+ruleObj[0]+"\"/><input type=\"hidden\" name=\"imports\" id=\"imports\"  value=\""+ruleObj[2]+"\"/><select name=\"thenObjBehavior\" id=\"then"+ruleObj[0]+"Behavior\" onchange=\"changeBehaviorValue(this.value,this.id)\">"+
	 "  <option value=\"\" >-请选择-</option>"
...
//设置条件
 ...
 //设置行为	
 	...
 	//alert(thenMapVal);
 	document.getElementById("thenMapVal").value=thenMapVal;
 	var salienceVal = document.getElementById("optionVal").value;
	//document.forms['saveForm'].submit();
	//var dg = frameElement.lhgDG;
	var whenMapKey = document.getElementById("whenMapKey").value;
	jQuery.ajax(
				{
					type: "post",
					dataType: "html",
					url: "${path}/iswapqa/rule/ruleAction!addRule.action",
					data: {
						whenMapVal:encodeURI(whenMapVal),
						paramTypeVal:encodeURI(paramTypeVal),
						salience:"salience",
						salienceVal:encodeURI(salienceVal),
						whenMapKey:encodeURI(whenMapKey),
						thenMapVal:encodeURI(thenMapVal)
					},
					async: false,
