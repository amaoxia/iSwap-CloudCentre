...
<div class="frameset_w" style="height:100%">
  <div class="main">
    <div class="common_menu">
      <div class="c_m_title"><img src="${path}/images/title/routineSet.png"  align="absmiddle" />帐号常规信息设置</div>
    </div>
    <div class="main_c2" >
...
<script type="text/javascript" class="source"> 
	...
	$(function () {
     ...
     .bind('loaded.jstree', function(event){
     	if(selectedId+"t"!="t"){
     		$("#content").attr("src","ftpClient!editRoutine.action?id="+selectedId);
     	}
	  })
		.bind('click.jstree', function(event){
			...
			if (eventNodeName == 'INS') {
				...
				if($city.parent().attr('rel')==''){
			 		$("#content").attr("src","ftpClient!editRoutine.action?id="+id);
			    }
			}
		})
		.jstree({
