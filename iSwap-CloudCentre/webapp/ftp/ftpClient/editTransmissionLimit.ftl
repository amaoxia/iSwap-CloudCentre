...
<body>	
<form action="ftpClient!saveTransmissionLimit.action" method="post" name="saveForm" id="saveForm">
...
<div class="loayt_01 rlist100" style="margin-top:10px;">
          <div class="loayt_top"><span class="loayt_tilte"><b>上传下载信息（${ftpUser.username?default("")}）</b></span><span class="loayt_right"><img src="${path}/images/kuang_right.png" width="10" height="31"/></span></div>
                    ...
                    <tr>
                      <td height="100%" valign="top" style="height:407px;"><div class="item1">
                          <ul class="item1_lu">
                            <li>
                              <p>
                                <input type="checkbox" name="ftpUser.enabletransmissionlimit" <#if ftpUser.enabletransmissionlimit>checked</#if> value="true" style="vertical-align:middle" />
                                启用</p>
                            </li>
                            <li class="item2_bg">
                              <p><span>每个任务文件:</span><br/>
                                  <input type="text" name="ftpUser.everytaskfiles" value="${ftpUser.everytaskfiles?default("")}" size="8" />
                                个</p>
                            </li>
                            <li><p><span>每个任务字节:</span><br/>
                                  <input type="text" name="ftpUser.everytasksize" value="${ftpUser.everytasksize?default("")}" size="8" />
                                KB</p></li>
                            <li class="item2_bg">
                              <p><span>所有任务文件：</span><br/>
                                  <input type="text" name="ftpUser.alltaskfiles" value="${ftpUser.alltaskfiles?default("")}" size="8" />
                                  个                              </p>
                            </li>
                            <li><p><span>所有任务字节:</span><br/>
                                  <input type="text" name="ftpUser.alltasksize" value="${ftpUser.alltasksize?default("")}" size="8" />
                                KB</p></li>
                          </ul>
