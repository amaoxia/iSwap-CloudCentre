		...
		<form name="pageForm" method="post"  action="${path}/exchange/sendItem/sendItem!list.action">
			...
			<input type="hidden" name="deptName" id="deptName" value="${deptName}"/>
			    <div class="common_menu">
			      ...
			      <div class="c_m_btn"> 
			      	<span class="cm_btn_m">
			      		<a href="javascript:void(0)" id="hz0" onclick="opdg('${path}/exchange/sendItem/sendItem!addView.action?deptId=${deptId}&deptName=${deptName}','新增指标','650','590');"><!-- encodeURI('${deptName})'-->
				      		<b>
