...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onclick="parent.hideMenu();">
		<form name="pageForm" method="post"  action="${path}/exchange/receiveItem/receiveItem!list.action">
			...
			<input type="hidden" name="deptName" id="deptName" value="${deptName}"/>
			    <div class="common_menu">
			      ...
			      <div class="c_m_btn"> 
			      	<span class="cm_btn_m">
			      		<a href="#" onclick="opdg('${path}/exchange/receiveItem/receiveItem!addView.action?deptId=${deptId}&deptName=${deptName}','新增指标','650','590');">
				      		<b>
		    	...
		    	<div class="main_c">
			       ...
			       <#list listDatas as entity>
					<tr <#if (entity_index+1)%2==0>class="trbg"</#if> onclick="selectedTD(this);">
			         ...
			         <td title="${entity.itemName?default('')}">
			          ...
			          <td width="15%">
				          <a href="javascript:void(0)" id="hz0" onclick="opdg('${path}/exchange/receiveItem/receiveItem!view.action?id=${entity.id}','查看','570','460');" class="tabs1_cz">
				          	<img src="${path}/images/small9/s_chakan.gif" />查看
				          </a> 
				          <a href="javascript:void(0)" id="hz0" onclick="opdg('${path}/exchange/receiveItem/receiveItem!updateView.action?id=${entity.id}&deptId=${deptId}&deptName=${deptName}','编辑','630','590');" class="tabs1_cz">
				          ...
				          <#if entity.dataType?exists>
				           <a href="#"  <#if entity.dataType=='1'> onclick="opdg('${path}/exchange/changeItemMapper/changeItemMapper!list.action?itemId=${entity.id}&deptId=${deptId}','mapper配置','1000','470');"<#else>style="color:#ccc;"</#if> class="tabs1_cz" >
				          	<img src="${path}/images/small9/s_biaojiegou.gif"/>mapper
				           </a>
				          </#if>
				          <a href="#" id="hz0"  class="tabs1_cz" onclick="del('${path}/exchange/receiveItem/receiveItem!delete.action?ids=${entity.id}')">
			      ...
			      <div class="tabs_foot"> 
				       <img src="${path}/images/tabsf_arrow.gif" align="bottom" style="margin-left:8px;margin-right:8px;" /><a href="javascript:void(0);" onclick="checkedAll(this,'ids');return false;">全选</a><img src="${path}/images/tabsf_line.jpg" align="absmiddle" style="margin:0 4px 0 10px;" />
	    			    <a href="javascript:void(0)" class="tfl_blink" onclick="delMany('${path}/exchange/receiveItem/receiveItem!delete.action')"><b class="hot">删除</b></a>
