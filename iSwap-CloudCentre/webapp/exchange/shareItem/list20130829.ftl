		...
		<form name="pageForm" method="post"  action="${path}/exchange/receiveDeptItem/receiveDeptItem!list.action">
			<input type="hidden" name="deptid" id="deptid" value="${deptid}"/>
	      	<div class="common_menu">
		      	<div class="c_m_title">
		      		<img src="${path}/images/title/item.png"  align="absmiddle" />接收数据指标项
		      	</div>
			  	<div class="c_m_btn"> 
			  		<span class="cm_btn_m">
				  		<a href="javascript:void(0)" id="hz0" onclick="opdg('${path}/exchange/item/item!addView.action?deptid=${deptid}&deptName=${deptName}&itemType=2','新增指标项','650','590')">
						  	<b>
