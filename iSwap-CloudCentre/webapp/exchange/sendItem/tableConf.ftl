		            ...
		            <tr>
		              ...
		              <div class="item1">
		                  <ul class="item1_c">
		                      ...
		                      <p>应用名称:</p>
		                      <span>
		                      <input type="text" size="30" value="${changeItem.appItemExchangeConf.appMsg.appName}" disabled="true"/>
		                      </span>
		                    </li>
		                    <li>
		                      <p>指标名称:</p>
		                      <span>
		                      <input type="text" size="30" value="${changeItem.appItemExchangeConf.appItem.appItemName}" disabled="true"/>
		                      </span>
		                    </li>
		                 	 <li class="item_bg">
		                      <p>交换类型:</p>
