...
<div class="frameset_w" style="height:100%">
  <div class="main">
    <div class="common_menu">
	  ...
	  <div class="c_m_btn"> 
	  	<span class="cm_btn_m">
	  		<a href="#" onclick="opChild('${path}/exchange/changeItemMapper/changeItemMapper!addView.action?itemId=${itemId}&deptId=${deptId}','新建Mapper','800','450');return false;"><#-- opdg('${path}/exchange/mapper/mapper!upload.action','mapper配置','500','270');-->
		  		<b>
    ...
    <div class="main_c">
    <form name="sel" id="pageForm" action="${path}/exchange/changeItemMapper/changeItemMapper!list.action" method="post">
    ...
    <table class="main_drop">
      ...
      <table class="tabs1" style="margin-top:0px;">
        ...
        <tr <#if entity_index%2==0>class="trbg"</#if>  onclick="selectedTD(this);">
          ...
          <td width="190">
          	<a href="javascript:void(0)" id="hz0" onclick="opChild('${path}/exchange/changeItemMapper/changeItemMapper!view.action?id=${entity.id}','查看','650','580');" class="tabs1_cz">
          		<img src="${path}/images/small9/s_chakan.gif" />查看
         	</a> 
          	<a id="hz2" href="#" <#if entity.status=='1'> style="color:#ccc;" <#else>onclick="opChild('${path}/exchange/changeItemMapper/changeItemMapper!updateView.action?id='+${entity.id},'编辑Mapper','650','580');" </#if> class="tabs1_cz"><img src="${path}/images/czimg_edit.gif" />编辑</a>&nbsp;<!--<a id="hz4" href="javascript:alertMsg('测试正常！');" class="tabs1_cz" ><img src="${path}/images/small9/s_ceshi.gif" />测试</a>&nbsp;--><#if entity.status=='0'><a href="javascript:void(0);" onclick="updateStatus('${path}/exchange/changeItemMapper/changeItemMapper!updateStatus.action?status=1&ids=${entity.id}');" class="tabs1_cz" ><img src="${path}/images/small9/s_bushu.gif" />部&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;署</a></#if><#if entity.status=='1'><a href="javascript:void(0);" onclick="updateStatus('${path}/exchange/changeItemMapper/changeItemMapper!updateStatus.action?status=0&ids=${entity.id}');" class="tabs1_cz" ><img src="${path}/images/small9/s_bushu.gif" />取消部署</a></#if></td>
        </tr>
		</#list>
      </table>
      <div class="tabs_foot"> <span class="tfl_btns"><img src="${path}/images/tabsf_arrow.gif" align="bottom" style="margin-left:8px; margin-right:8px;" /><a href="javascript:void(0);" onclick="checkedAll(this,'ids');return false;">全选</a><img src="${path}/images/tabsf_line.jpg" align="absmiddle" style="margin:0 4px 0 10px;" /><a href="javascript:void(0)" onclick="delMany('${path}/exchange/changeItemMapper/changeItemMapper!delMany.action');" class="tfl_blink"><b class="hot">删除</b></a></span> 
