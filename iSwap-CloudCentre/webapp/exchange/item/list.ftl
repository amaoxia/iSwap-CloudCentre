...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onclick="parent.hideMenu();">
		<form name="pageForm" method="post"  action="${path}/exchange/item/item!list.action">
			<input type="hidden" name="deptid" id="deptid" value="${deptid}"/>
			    <div class="common_menu">
			      ...
			      <div class="c_m_btn"> 
			      	<span class="cm_btn_m">
			      		<a href="javascript:void(0)" id="hz0" onclick="opdg('${path}/exchange/item/item!addView.action?deptid=${deptid}&deptName=${deptName}&itemType=2','新增指标','650','590');">
				      		<b>
		    	...
		    	<div class="main_c">
		           <table class="main_drop">
	          			...
	          			<td align="right">
			  				...
			  				<#if deptName != "NO" >
			  				<#if deptid?exists><#else>所属部门：</#if><input name="deptName" onkeypress="showKeyPress()"  value="${deptName?default('')}" type="text" style="<#if deptid?exists>display:none;</#if>"/><!--onpaste="return false"-->
			  				</#if>
					...
					<tr <#if (entity_index+1)%2==0>class="trbg"</#if> onclick="selectedTD(this);">
			         ...
			         <td title="${entity.itemName?default('')}">
			          ...
			          <td width="15%">
				          ...
				          <a href="javascript:void(0)" id="hz0" onclick="opdg('${path}/exchange/item/item!updateView.action?id=${entity.id}&deptid=${deptid}&deptName=${deptName}','编辑','630','590');" class="tabs1_cz">
				          ...
				          <a href="#" id="hz0"  class="tabs1_cz" onclick="del('${path}/exchange/item/item!delete.action?ids=${entity.id}')">
			      ...
			      <div class="tabs_foot"> 
				       <img src="${path}/images/tabsf_arrow.gif" align="bottom" style="margin-left:8px;margin-right:8px;" /><a href="javascript:void(0);" onclick="checkedAll(this,'ids');return false;">全选</a><img src="${path}/images/tabsf_line.jpg" align="absmiddle" style="margin:0 4px 0 10px;" />
	    			    <a href="javascript:void(0)" class="tfl_blink" onclick="delMany('${path}/exchange/item/item!delete.action')"><b class="hot">删除</b></a>
