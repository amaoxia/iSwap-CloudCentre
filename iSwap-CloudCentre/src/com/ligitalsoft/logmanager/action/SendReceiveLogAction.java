 ...
 * @since   2013-12-16下午5:24:01
 * @name    SendReceiveLogAction.java
 * @version iSwap V1.0
 * @Team    研发中心
 */
@Scope("prototype")
@Namespace("/logmanager/sendReceiveLog")
@Action("sendReceiveLog")
@Results({ @Result(name = StrutsAction.RELOAD, location = "../../common/succ.ftl", type = "freemarker"),
        @Result(name = "listAction", location = "sendReceiveLog!list.action", type = "redirectAction", params = {}) })
public class SendReceiveLogAction extends FreemarkerBaseAction<ChangeItem> {
