 ...
 * @since   2013-12-16下午5:21:06
 * @name    LoginLogAction.java
 * @version iSwap V1.0
 * @Team    研发中心
 */
@Scope("prototype")
@Namespace("/logmanager/loginLog")
@Action("loginLog")
@Results({ @Result(name = StrutsAction.RELOAD, location = "../../common/succ.ftl", type = "freemarker"),
        @Result(name = "listAction", location = "loginLog!list.action", type = "redirectAction", params = {}) })
public class LoginLogAction extends FreemarkerBaseAction<ChangeItem> {
