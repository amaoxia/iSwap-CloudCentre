 ...
 * @since   2013-12-16下午5:24:45
 * @name    WorkFlowRunLogAction.java
 * @version iSwap V1.0
 * @Team    研发中心
 */
@Scope("prototype")
@Namespace("/logmanager/workFlowRunLog")
@Action("workFlowRunLog")
@Results({ @Result(name = StrutsAction.RELOAD, location = "../../common/succ.ftl", type = "freemarker"),
        @Result(name = "listAction", location = "workFlowRunLog!list.action", type = "redirectAction", params = {}) })
public class WorkFlowRunLogAction extends FreemarkerBaseAction<ChangeItem> {
