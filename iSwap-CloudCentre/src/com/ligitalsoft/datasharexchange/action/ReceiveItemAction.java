...
@Scope("prototype")
@Namespace("/exchange/receiveItem")
@Results({
		@Result(name = StrutsAction.RELOAD, location = "../../common/succ.ftl", type = "freemarker"),
		@Result(name = "listAction", location = "receiveItem!list.action", type = "redirectAction", params = {
				"deptId", "${deptId}","deptName", "${deptName}"}) })
@Action("receiveItem")
public class ReceiveItemAction extends FreemarkerBaseAction<ChangeItem> {
